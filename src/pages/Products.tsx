...
const Products = () => {
  ...
  const loadProducts = async (page = 1) => {
    ...
    try {
      ...
      if (filters.category) params.category = Number.parseInt(filters.category);
      if (filters.search) params.search = filters.search;
      if (filters.minPrice)
        params.min_price = Number.parseFloat(filters.minPrice);
      if (filters.maxPrice)
        params.max_price = Number.parseFloat(filters.maxPrice);
